...
**Divine Simplicity**, and **Divine Immutability** (invariant across modal worlds, temporal stages,
and agential state transitions). The remaining divine attributes — **unity / monotheism**,
