...
| `GroundProp` | A8 | `VOCAB` | The grounding relation between an entity and a proposition. | C124, C143, C144, C32, C33 |
...
| `State` | A11 | `VOCAB` | Vocabulary: abstract state space for initiation of movement. | C100, C101, C102, C103, C104, C105, C106, C124, C133, C135, C137, C138, C139, C140, C141, C143, C144, C21, C23, C24, C25, C30, C32, C33, C39, C52, C53, C55, C57, C62, C68, C77, C83, C84, C92, C94, C97, C98, C99, F1b |
| `Initiates` | A12 | `VOCAB` | Vocabulary: the initiation relation — a subject initiates a transition between states positing content. | C100, C101, C102, C103, C104, C105, C106, C124, C133, C135, C137, C138, C139, C140, C141, C143, C144, C21, C23, C24, C25, C30, C32, C33, C39, C52, C53, C55, C57, C62, C68, C77, C83, C84, C92, C94, C97, C98, C99, F1b |
...
| `AxIntentionalChoice` | A14 | `SEM` | Genuine choice is constitutive of intentional action: an intentional act is an initiation performed through the subject's apprehension of an incompatible alternative. | C133, C135, F1b |
...
- GAPMAP claims with a kernel declaration located (FOUND): **133** / 159
- Steps with an **English meaning in code**: **159** / 159
...
- **Kernel × GAPMAP footprint divergences** (11 — fix the GAPMAP ledger):
  ...
  - `C126` kernel `{GroundsEntity, Means, Subject, Will, subjectWill}` vs GAPMAP `{GroundProp, Means, Subject}`
  - `C127` kernel `{DivineNature, GroundsEntity, HasNature, Means, Nature, PersonalNature, Subject, Will, divine_nature_is_personal, divine_person_is_necessary, personal_nature_iff_person, subjectWill}` vs GAPMAP `{GroundsEntity, Subject, Will, divine_nature_is_personal, divine_person_is_necessary, personal_nature_iff_person}`
  - `C129` kernel `{GroundsEntity, Means, Subject, Will, subjectWill}` vs GAPMAP `{GroundsEntity, Subject, Will}`
  - `C132` kernel `{DivineNature, HasNature, Means, Nature, PersonalNature, Subject, divine_nature_is_personal, personal_nature_iff_person}` vs GAPMAP `{Means, Subject, divine_nature_is_personal, personal_nature_iff_person}`
  - `C134` kernel `{DivineNature, GroundsEntity, HasNature, Means, Nature, PersonalNature, Subject, Will, divine_nature_is_personal, divine_person_is_necessary, personal_nature_iff_person, subjectWill}` vs GAPMAP `{GroundsEntity, Subject, Will, divine_nature_is_personal, divine_person_is_necessary, personal_nature_iff_person}`
- **Graph (closure) × audit (#print axioms) diverge on 7 claims** (depviz transitive undercount — toolchain, not ledger; the audit decides):
  - `FAITH-2` audit `{AxTwoSubjects, Means, Subject}` vs graph `{}`
  - `C117` audit `{AxSecondPersonalAddress, Means, Ought, Subject}` vs graph `{}`
  - `C127` audit `{DivineNature, GroundsEntity, HasNature, Means, Nature, PersonalNature, Subject, Will, divine_nature_is_personal, divine_person_is_necessary, personal_nature_iff_person, subjectWill}` vs graph `{DivineNature, GroundsEntity, HasNature, Means, PersonalNature, Subject, Will, divine_nature_is_personal, divine_person_is_necessary, personal_nature_iff_person, subjectWill}`
  - `C130` audit `{AxRealityGrounding, Ground, GroundsEntity, Subject}` vs graph `{}`
  - `C132` audit `{DivineNature, HasNature, Means, Nature, PersonalNature, Subject, divine_nature_is_personal, personal_nature_iff_person}` vs graph `{DivineNature, HasNature, Means, PersonalNature, Subject, divine_nature_is_personal, personal_nature_iff_person}`
  - `C134` audit `{DivineNature, GroundsEntity, HasNature, Means, Nature, PersonalNature, Subject, Will, divine_nature_is_personal, divine_person_is_necessary, personal_nature_iff_person, subjectWill}` vs graph `{DivineNature, GroundsEntity, HasNature, Means, PersonalNature, Subject, Will, divine_nature_is_personal, divine_person_is_necessary, personal_nature_iff_person, subjectWill}`
  - `C143` audit `{AxPersonalNormativeGround, GroundProp, Initiates, Means, State, Subject, Will, subjectWill}` vs graph `{}`
- Axioms declared in the kernel: **36** — **all carry a `Tag:` line on their Lean docstring**
...
| C32 | `Logos.GroundPerson.T8_personalGround` | [GroundPerson.lean#L114](formal/Logos/GroundPerson.lean#L114) | `{AxPersonalGround, GroundProp, Initiates, Means, State, Subject}` | `GroundPerson.AxGroundBearing`, axiom `AxPersonalGround` (META), axiom `GroundProp` (VOCAB), `GroundPerson.IsPresentPersonalFeature`, `GroundPerson.Personal`, `GroundPerson.Realizes`, `Modal.NecessaryEntity`, `Truthmaker.Entity` | — |
| C33 | `Logos.GroundPerson.present_feature_is_grounded` | [GroundPerson.lean#L122](formal/Logos/GroundPerson.lean#L122) | `{GroundPrincipleProp, GroundProp, Initiates, Means, State, Subject}` | `Core.T`, axiom `GroundPrincipleProp` (SEM), axiom `GroundProp` (VOCAB), `GroundPerson.IsPresentPersonalFeature`, `Truthmaker.Entity` | — |
| C34 | `Logos.GroundPerson.necessary_truth_has_necessary_grounder` | [GroundPerson.lean#L127](formal/Logos/GroundPerson.lean#L127) | `{AxGlobalGround, Ground, Subject}` | `Modal.NecessaryEntity`, **C18** `T7_necessaryReality`, `Semantics.Form`, `Truthmaker.Entity`, axiom `Ground` (VOCAB), `Truthmaker.NecessarilyTrue` | — |
...
| C120 | `Logos.Person.free_subject_is_person` | [Person.lean#L33](formal/Logos/Person.lean#L33) | `{Means, Subject}` | axiom `Subject` (VOCAB), `Choice.FreeSubject`, `Person.Person` | `NecessaryPersonalGround.established_will_reality`, `NecessaryPersonalGround.person_exists`, `OughtRetorsion.free_subject_is_person`, `PersonhoodOntologyAudit.free_subject_is_person` |
...
| C124 | `Logos.NecessaryPersonalGround.claim_c_implies_claim_b` | [NecessaryPersonalGround.lean#L175](formal/Logos/NecessaryPersonalGround.lean#L175) | `{GroundProp, Initiates, Means, State, Subject}` | `GroundPerson.Personal`, `Modal.NecessaryEntity`, `NecessaryPersonalGround.ClaimB_NecessaryReality`, `NecessaryPersonalGround.ClaimC_HistoricalT8`, `Truthmaker.Entity` | — |
| C125 | `Logos.NecessaryPersonalGround.claim_d_implies_claim_b` | [NecessaryPersonalGround.lean#L168](formal/Logos/NecessaryPersonalGround.lean#L168) | `{Means, Subject}` | axiom `Subject` (VOCAB), `Modal.NecessaryEntity`, **C91** `subject_nec_entity_nec`, `NecessaryPersonalGround.ClaimB_NecessaryReality`, `NecessaryPersonalGround.ClaimD_NecessaryPerson`, `Person.Person`, `Plurality.NecessarySubject`, `Truthmaker.Entity`, `Truthmaker.EntityOf` | — |
| C126 | `Logos.NecessaryPersonalGround.claim_e_implies_claim_b` | [NecessaryPersonalGround.lean#L161](formal/Logos/NecessaryPersonalGround.lean#L161) | `{GroundsEntity, Means, Subject, Will, subjectWill}` | `Modal.NecessaryEntity`, `NecessaryPersonalGround.ClaimB_NecessaryReality`, `NecessaryPersonalGround.ClaimE_NecessaryPersonalGround`, `NecessaryPersonalGround.GroundsPersonalReality`, `NecessaryPersonalGround.ImpersonalEntity`, `NecessaryPersonalGround.NecessaryPersonalGround`, `Truthmaker.Entity` | — |
| C127 | `Logos.NecessaryPersonalGround.claim_e_implies_claim_d` | [NecessaryPersonalGround.lean#L575](formal/Logos/NecessaryPersonalGround.lean#L575) | `{divine_nature_is_personal, divine_person_is_necessary, personal_nature_iff_person, DivineNature, GroundsEntity, HasNature, Means, Nature, PersonalNature, Subject, Will, subjectWill}` | `NecessaryPersonalGround.ClaimD_NecessaryPerson`, `NecessaryPersonalGround.TrinitarianGodhead`, `NecessaryPersonalGround.trinitarian_godhead_yields_necessary_person`, `Truthmaker.Entity` | — |
| C128 | `Logos.NecessaryPersonalGround.ofAtom_ne_ofSubject` | [NecessaryPersonalGround.lean#L185](formal/Logos/NecessaryPersonalGround.lean#L185) | `{Subject}` | axiom `Subject` (VOCAB), `Truthmaker.Entity`, `Truthmaker.EntityOf` | `NecessaryPersonalGround.impersonal_ground_refuted`, **C133** `necessary_personal_ground_derived` |
| C129 | `Logos.NecessaryPersonalGround.ofAtom_not_necessary_personal_ground` | [NecessaryPersonalGround.lean#L347](formal/Logos/NecessaryPersonalGround.lean#L347) | `{GroundsEntity, Means, Subject, Will, subjectWill}` | `Modal.NecessaryEntity`, `NecessaryPersonalGround.GroundsPersonalReality`, `NecessaryPersonalGround.ImpersonalEntity`, `NecessaryPersonalGround.NecessaryPersonalGround`, `Truthmaker.Entity` | — |
| C130 | `Logos.NecessaryPersonalGround.AxRealityGrounding` | [NecessaryPersonalGround.lean#L309](formal/Logos/NecessaryPersonalGround.lean#L309) | `{AxRealityGrounding, Ground, GroundsEntity, Subject}` | `Modal.NecessaryEntity`, `NecessaryPersonalGround.ActualEntity`, axiom `GroundsEntity` (VOCAB), `Semantics.Form`, `Truthmaker.Entity`, axiom `Ground` (VOCAB), `Truthmaker.NecessarilyTrue` | `NecessaryPersonalGround.necessary_ground_for_all_reality`, **C133** `necessary_personal_ground_derived` |
| C131 | `Logos.NecessaryPersonalGround.de_dicto_not_implies_de_re` | [NecessaryPersonalGround.lean#L612](formal/Logos/NecessaryPersonalGround.lean#L612) | `{}` | — | — |
| C132 | `Logos.NecessaryPersonalGround.divine_subject_is_person` | [NecessaryPersonalGround.lean#L92](formal/Logos/NecessaryPersonalGround.lean#L92) | `{divine_nature_is_personal, personal_nature_iff_person, DivineNature, HasNature, Means, Nature, PersonalNature, Subject}` | axiom `HasNature` (VOCAB), axiom `Subject` (VOCAB), axiom `DivineNature` (VOCAB), axiom `PersonalNature` (VOCAB), axiom `divine_nature_is_personal` (SEM), axiom `personal_nature_iff_person` (SEM), `Person.Person` | `NecessaryPersonalGround.trinitarian_godhead_yields_necessary_person`, `NecessaryPersonalGround.trinitarian_persons_are_personal` |
| C133 | `Logos.NecessaryPersonalGround.necessary_personal_ground_derived` | [NecessaryPersonalGround.lean#L381](formal/Logos/NecessaryPersonalGround.lean#L381) | `{AxGlobalGround, AxIntentionalChoice, AxRealityGrounding, explanatory_adequacy, Ground, GroundsEntity, Initiates, Means, State, Subject, Will, subjectWill, CL}` | `Agency.Asserts`, axiom `Subject` (VOCAB), axiom `Will` (VOCAB), axiom `subjectWill` (VOCAB), `Choice.FreeSubject`, `Choice.FreeWill`, `Modal.NecessaryEntity`, **C18** `T7_necessaryReality`, `NecessaryPersonalGround.ActualEntity`, **C130** `AxRealityGrounding`, `NecessaryPersonalGround.ClaimE_NecessaryPersonalGround`, axiom `GroundsEntity` (VOCAB), `NecessaryPersonalGround.GroundsPersonalReality`, `NecessaryPersonalGround.ImpersonalEntity`, `NecessaryPersonalGround.NecessaryPersonalGround`, `NecessaryPersonalGround.atom_cannot_ground_person`, `NecessaryPersonalGround.established_will_reality`, **C128** `ofAtom_ne_ofSubject`, `NecessaryPersonalGround.step1_necessary_truth_exists`, `Person.Person`, `Semantics.Form`, `Truthmaker.Entity`, `Truthmaker.EntityOf`, axiom `Ground` (VOCAB), `Truthmaker.NecessarilyTrue` | **C135** `monotheism_derived`, `NecessaryPersonalGround.necessary_ground_is_personal` |
| C134 | `Logos.NecessaryPersonalGround.necessary_person_derived` | [NecessaryPersonalGround.lean#L571](formal/Logos/NecessaryPersonalGround.lean#L571) | `{divine_nature_is_personal, divine_person_is_necessary, personal_nature_iff_person, DivineNature, GroundsEntity, HasNature, Means, Nature, PersonalNature, Subject, Will, subjectWill}` | `NecessaryPersonalGround.ClaimD_NecessaryPerson`, `NecessaryPersonalGround.TrinitarianGodhead`, `NecessaryPersonalGround.trinitarian_godhead_yields_necessary_person`, `Truthmaker.Entity` | — |
| C135 | `Logos.NecessaryPersonalGround.monotheism_derived` | [NecessaryPersonalGround.lean#L500](formal/Logos/NecessaryPersonalGround.lean#L500) | `{AxGlobalGround, AxIntentionalChoice, AxRealityGrounding, explanatory_adequacy, universal_ground_unique, Ground, GroundsEntity, Initiates, Means, State, Subject, Will, subjectWill, CL}` | `Agency.Asserts`, axiom `Subject` (VOCAB), `NecessaryPersonalGround.ClaimE_NecessaryPersonalGround`, `NecessaryPersonalGround.God`, `NecessaryPersonalGround.Monotheism`, `NecessaryPersonalGround.NecessaryPersonalGround`, `NecessaryPersonalGround.divine_uniqueness`, **C133** `necessary_personal_ground_derived`, `Truthmaker.Entity` | — |
| C136 | `Logos.NecessaryPersonalGround.monotheism_compatible_with_trinity` | [NecessaryPersonalGround.lean#L582](formal/Logos/NecessaryPersonalGround.lean#L582) | `{CL}` | — | — |
...
| C142 | `Logos.Person.person_iff_freeIndependentWill` | [Person.lean#L71](formal/Logos/Person.lean#L71) | `{Means, Subject, Will, subjectWill, will_individuation}` | axiom `Subject` (VOCAB), `Choice.FreeWill`, `Person.FreeIndependentWill`, `Person.IndependentWill`, `Person.Person`, `Person.independent_will_of_subject` | `Person.free_independent_will_is_person`, `Person.person_has_free_independent_will`, **C144** `person_grounds_normative_polarity`, `PersonalNormativeGround.person_realizes_grounded_polarity` |
| C143 | `Logos.PersonalNormativeGround.AxPersonalNormativeGround` | [PersonalNormativeGround.lean#L144](formal/Logos/PersonalNormativeGround.lean#L144) | `{AxPersonalNormativeGround, GroundProp, Initiates, Means, State, Subject, Will, subjectWill}` | `Agency.Act`, axiom `Subject` (VOCAB), `Person.FreeIndependentWill`, `PersonalNormativeGround.GroundsJudicativePolarity` | `PersonalNormativeGround.free_independent_will_grounds_judicative_polarity` |
| C144 | `Logos.PersonalNormativeGround.person_grounds_normative_polarity` | [PersonalNormativeGround.lean#L163](formal/Logos/PersonalNormativeGround.lean#L163) | `{AxPersonalNormativeGround, GroundProp, Initiates, Means, State, Subject, Will, subjectWill, will_individuation}` | `Agency.Act`, axiom `Subject` (VOCAB), `Person.FreeIndependentWill`, `Person.Person`, **C142** `person_iff_freeIndependentWill`, `PersonalNormativeGround.GroundsJudicativePolarity`, `PersonalNormativeGround.free_independent_will_grounds_judicative_polarity` | `PersonalNormativeGround.person_realizes_grounded_polarity` |
| C145 | `Logos.PersonalNormativeGround.discovery_independent_of_grounding` | [PersonalNormativeGround.lean#L198](formal/Logos/PersonalNormativeGround.lean#L198) | `{Means, Subject}` | axiom `Subject` (VOCAB), `Choice.Chooses`, `Choice.FreeWill`, `IndubitableNormativeFreeWill.GenuineNormativity`, **C107** `indubitable_normative_free_will` | — |
...
| `T8_personalGround` | theorem | [L114](formal/Logos/GroundPerson.lean#L114) | `theorem T8_personalGround {f : Prop} (hf : IsPresentPersonalFeature f) : ∃ e : E` | {AxPersonalGround, GroundProp, Initiates, Means, State, Subject} → C32 |
| `necessary_truth_has_necessary_grounder` | theorem | [L127](formal/Logos/GroundPerson.lean#L127) | `theorem necessary_truth_has_necessary_grounder {τ : Form} (hτ : Logos.Truthmaker` | {AxGlobalGround, Ground, Subject} → C34 |
| `present_feature_is_grounded` | theorem | [L122](formal/Logos/GroundPerson.lean#L122) | `theorem present_feature_is_grounded {f : Prop} (ht : T f) (_hf : IsPresentPerson` | {GroundPrincipleProp, GroundProp, Initiates, Means, State, Subject} → C33 |
...
| `G_ambient_derivable` | theorem | [L3640](formal/Logos/HostileSemantics.lean#L3640) | `theorem G_ambient_derivable : G` | {GroundPrincipleProp, GroundProp, Subject}  |
...
| `T_G_ambient_derivable` | theorem | [L3645](formal/Logos/HostileSemantics.lean#L3645) | `theorem T_G_ambient_derivable : T G` | {GroundPrincipleProp, GroundProp, Subject}  |
...
| Name | Kind | Line | Statement (logic) | Axioms |
|---|---|---|---|---|
| `ActualEntity` | def | [L106](formal/Logos/NecessaryPersonalGround.lean#L106) | `def ActualEntity (e : Entity) : Prop` | {Subject}  |
| `AxRealityGrounding` | axiom | [L309](formal/Logos/NecessaryPersonalGround.lean#L309) | `axiom AxRealityGrounding : ∀ (g : Entity), NecessaryEntity g → (∃ τ : Form, □ τ ` | {AxRealityGrounding, Ground, GroundsEntity, Subject} → C130 |
| `ClaimA_NecessaryTruth` | def | [L137](formal/Logos/NecessaryPersonalGround.lean#L137) | `def ClaimA_NecessaryTruth (φ : Form) : Prop` | {}  |
| `ClaimB_NecessaryReality` | def | [L140](formal/Logos/NecessaryPersonalGround.lean#L140) | `def ClaimB_NecessaryReality : Prop` | {Subject}  |
| `ClaimC_HistoricalT8` | def | [L145](formal/Logos/NecessaryPersonalGround.lean#L145) | `def ClaimC_HistoricalT8 : Prop` | {GroundProp, Initiates, Means, State, Subject}  |
| `ClaimD_NecessaryPerson` | def | [L149](formal/Logos/NecessaryPersonalGround.lean#L149) | `def ClaimD_NecessaryPerson : Prop` | {Means, Subject}  |
| `ClaimE_NecessaryPersonalGround` | def | [L153](formal/Logos/NecessaryPersonalGround.lean#L153) | `def ClaimE_NecessaryPersonalGround : Prop` | {GroundsEntity, Means, Subject, Will, subjectWill}  |
| `DivineNature` | axiom | [L82](formal/Logos/NecessaryPersonalGround.lean#L82) | `axiom DivineNature : Nature` | {DivineNature, Nature}  |
| `EntityMeans` | def | [L205](formal/Logos/NecessaryPersonalGround.lean#L205) | `def EntityMeans (e : Entity) (p : Prop) : Prop` | {Means, Subject}  |
| `God` | def | [L476](formal/Logos/NecessaryPersonalGround.lean#L476) | `def God (g : Entity) : Prop` | {GroundsEntity, Means, Subject, Will, subjectWill}  |
| `GroundOfAllReality` | def | [L302](formal/Logos/NecessaryPersonalGround.lean#L302) | `def GroundOfAllReality (g : Entity) : Prop` | {Ground, GroundsEntity, Subject}  |
| `GroundsEntity` | axiom | [L113](formal/Logos/NecessaryPersonalGround.lean#L113) | `axiom GroundsEntity : Entity → Entity → Prop` | {GroundsEntity, Subject}  |
| `GroundsPersonalReality` | def | [L119](formal/Logos/NecessaryPersonalGround.lean#L119) | `def GroundsPersonalReality (g : Entity) : Prop` | {GroundsEntity, Means, Subject, Will, subjectWill}  |
| `ImpersonalEntity` | def | [L109](formal/Logos/NecessaryPersonalGround.lean#L109) | `def ImpersonalEntity (e : Entity) : Prop` | {Subject}  |
| `Monotheism` | def | [L480](formal/Logos/NecessaryPersonalGround.lean#L480) | `def Monotheism : Prop` | {GroundsEntity, Means, Subject, Will, subjectWill}  |
| `NecessaryPersonalGround` | def | [L129](formal/Logos/NecessaryPersonalGround.lean#L129) | `def NecessaryPersonalGround (g : Entity) : Prop` | {GroundsEntity, Means, Subject, Will, subjectWill}  |
| `PersonalNature` | axiom | [L73](formal/Logos/NecessaryPersonalGround.lean#L73) | `axiom PersonalNature : Nature` | {Nature, PersonalNature}  |
| `TrinitarianGodhead` | def | [L517](formal/Logos/NecessaryPersonalGround.lean#L517) | `def TrinitarianGodhead (G : Entity) : Prop` | {DivineNature, GroundsEntity, HasNature, Means, Nature, Subject, Will, subjectWill}  |
| `atom_cannot_ground_intentional_subject` | theorem | [L220](formal/Logos/NecessaryPersonalGround.lean#L220) | `theorem atom_cannot_ground_intentional_subject (n : Nat) (s : Subject) (p : Prop` | {explanatory_adequacy, GroundsEntity, Means, Subject}  |
| `atom_cannot_ground_person` | theorem | [L233](formal/Logos/NecessaryPersonalGround.lean#L233) | `theorem atom_cannot_ground_person (n : Nat) (s : Subject) (hPerson : Person s) :` | {explanatory_adequacy, GroundsEntity, Means, Subject}  |
| `claim_c_implies_claim_b` | theorem | [L175](formal/Logos/NecessaryPersonalGround.lean#L175) | `theorem claim_c_implies_claim_b : ClaimC_HistoricalT8 → ClaimB_NecessaryReality` | {GroundProp, Initiates, Means, State, Subject} → C124 |
| `claim_d_implies_claim_b` | theorem | [L168](formal/Logos/NecessaryPersonalGround.lean#L168) | `theorem claim_d_implies_claim_b : ClaimD_NecessaryPerson → ClaimB_NecessaryReali` | {Means, Subject} → C125 |
| `claim_e_implies_claim_b` | theorem | [L161](formal/Logos/NecessaryPersonalGround.lean#L161) | `theorem claim_e_implies_claim_b : ClaimE_NecessaryPersonalGround → ClaimB_Necess` | {GroundsEntity, Means, Subject, Will, subjectWill} → C126 |
| `claim_e_implies_claim_d` | theorem | [L575](formal/Logos/NecessaryPersonalGround.lean#L575) | `theorem claim_e_implies_claim_d {G : Entity} (t : TrinitarianGodhead G) : ClaimD` | {divine_nature_is_personal, divine_person_is_necessary, personal_nature_iff_person, DivineNature, GroundsEntity, HasNature, Means, Nature, PersonalNature, Subject, Will, subjectWill} → C127 |
| `de_dicto_not_implies_de_re` | theorem | [L612](formal/Logos/NecessaryPersonalGround.lean#L612) | `theorem de_dicto_not_implies_de_re : ∃ (W : Type) (S : Type) (ExistsAt : W → S →` | {} → C131 |
| `divine_nature_is_personal` | axiom | [L87](formal/Logos/NecessaryPersonalGround.lean#L87) | `axiom divine_nature_is_personal (s : Subject) : HasNature s DivineNature → HasNa` | {divine_nature_is_personal, DivineNature, HasNature, Nature, PersonalNature, Subject}  |
| `divine_person_is_necessary` | axiom | [L98](formal/Logos/NecessaryPersonalGround.lean#L98) | `axiom divine_person_is_necessary (s : Subject) : HasNature s DivineNature → Nece` | {divine_person_is_necessary, DivineNature, HasNature, Nature, Subject}  |
| `divine_subject_is_person` | theorem | [L92](formal/Logos/NecessaryPersonalGround.lean#L92) | `theorem divine_subject_is_person (s : Subject) (h : HasNature s DivineNature) : ` | {divine_nature_is_personal, personal_nature_iff_person, DivineNature, HasNature, Means, Nature, PersonalNature, Subject} → C132 |
| `divine_uniqueness` | theorem | [L495](formal/Logos/NecessaryPersonalGround.lean#L495) | `theorem divine_uniqueness (g₁ g₂ : Entity) (h1 : God g₁) (h2 : God g₂) : g₁ = g₂` | {universal_ground_unique, GroundsEntity, Means, Subject, Will, subjectWill}  |
| `established_will_reality` | theorem | [L284](formal/Logos/NecessaryPersonalGround.lean#L284) | `theorem established_will_reality (hAssert : ∃ s : Subject, ∃ p : Prop, Logos.Age` | {AxIntentionalChoice, Initiates, Means, State, Subject, Will, subjectWill}  |
| `explanatory_adequacy` | axiom | [L213](formal/Logos/NecessaryPersonalGround.lean#L213) | `axiom explanatory_adequacy : ∀ (g e : Entity), GroundsEntity g e → (∀ p : Prop, ` | {explanatory_adequacy, GroundsEntity, Means, Subject}  |
| `free_subject_exists` | theorem | [L452](formal/Logos/NecessaryPersonalGround.lean#L452) | `theorem free_subject_exists (h : ∃ s : Subject, ∃ p : Prop, Logos.Agency.Act s p` | {AxIntentionalChoice, Initiates, Means, State, Subject}  |
| `free_will_established` | theorem | [L447](formal/Logos/NecessaryPersonalGround.lean#L447) | `theorem free_will_established (h : ∃ s : Subject, ∃ p : Prop, Logos.Agency.Act s` | {AxIntentionalChoice, Initiates, Means, State, Subject}  |
| `genuine_choice_established` | theorem | [L442](formal/Logos/NecessaryPersonalGround.lean#L442) | `theorem genuine_choice_established (s : Subject) (p : Prop) (hAct : Logos.Agency` | {AxIntentionalChoice, Initiates, Means, State, Subject}  |
| `grounds_personal_reality_derived` | theorem | [L353](formal/Logos/NecessaryPersonalGround.lean#L353) | `theorem grounds_personal_reality_derived (g : Entity) (hAll : GroundOfAllReality` | {AxIntentionalChoice, Ground, GroundsEntity, Initiates, Means, State, Subject, Will, subjectWill, CL}  |
| `impersonal_ground_refuted` | theorem | [L329](formal/Logos/NecessaryPersonalGround.lean#L329) | `theorem impersonal_ground_refuted (g : Entity) (hAll : GroundOfAllReality g) (hA` | {AxIntentionalChoice, explanatory_adequacy, Ground, GroundsEntity, Initiates, Means, State, Subject, Will, subjectWill}  |
| `impersonal_not_necessary` | theorem | [L199](formal/Logos/NecessaryPersonalGround.lean#L199) | `theorem impersonal_not_necessary (e : Entity) : ImpersonalEntity e → ¬ Necessary` | {Subject}  |
| `monotheism_compatible_with_trinity` | theorem | [L582](formal/Logos/NecessaryPersonalGround.lean#L582) | `theorem monotheism_compatible_with_trinity : ∃ (Entity : Type) (Subject : Type) ` | {CL} → C136 |
| `monotheism_derived` | theorem | [L500](formal/Logos/NecessaryPersonalGround.lean#L500) | `theorem monotheism_derived (hAssert : ∃ s : Subject, ∃ p : Prop, Logos.Agency.As` | {AxGlobalGround, AxIntentionalChoice, AxRealityGrounding, explanatory_adequacy, universal_ground_unique, Ground, GroundsEntity, Initiates, Means, State, Subject, Will, subjectWill, CL} → C135 |
| `monotheism_of_god_and_uniqueness` | theorem | [L505](formal/Logos/NecessaryPersonalGround.lean#L505) | `theorem monotheism_of_god_and_uniqueness {g : Entity} (hGod : God g) : Monotheis` | {universal_ground_unique, GroundsEntity, Means, Subject, Will, subjectWill}  |
| `necessary_ground_for_all_reality` | theorem | [L315](formal/Logos/NecessaryPersonalGround.lean#L315) | `theorem necessary_ground_for_all_reality : ∃ g : Entity, NecessaryEntity g ∧ Gro` | {AxGlobalGround, AxRealityGrounding, Ground, GroundsEntity, Subject, CL}  |
| `necessary_ground_is_personal` | theorem | [L419](formal/Logos/NecessaryPersonalGround.lean#L419) | `theorem necessary_ground_is_personal (hAssert : ∃ s : Subject, ∃ p : Prop, Logos` | {AxGlobalGround, AxIntentionalChoice, AxRealityGrounding, explanatory_adequacy, Ground, GroundsEntity, Initiates, Means, State, Subject, Will, subjectWill, CL}  |
| `necessary_person_derived` | theorem | [L571](formal/Logos/NecessaryPersonalGround.lean#L571) | `theorem necessary_person_derived {G : Entity} (t : TrinitarianGodhead G) : Claim` | {divine_nature_is_personal, divine_person_is_necessary, personal_nature_iff_person, DivineNature, GroundsEntity, HasNature, Means, Nature, PersonalNature, Subject, Will, subjectWill} → C134 |
| `necessary_personal_ground_derived` | theorem | [L381](formal/Logos/NecessaryPersonalGround.lean#L381) | `theorem necessary_personal_ground_derived (hAssert : ∃ s : Subject, ∃ p : Prop, ` | {AxGlobalGround, AxIntentionalChoice, AxRealityGrounding, explanatory_adequacy, Ground, GroundsEntity, Initiates, Means, State, Subject, Will, subjectWill, CL} → C133 |
| `necessary_reality_exists` | theorem | [L467](formal/Logos/NecessaryPersonalGround.lean#L467) | `theorem necessary_reality_exists : ∃ e : Entity, NecessaryEntity e ∧ ∃ τ : Form,` | {AxGlobalGround, Ground, Subject, CL}  |
| `necessary_truth_exists` | theorem | [L463](formal/Logos/NecessaryPersonalGround.lean#L463) | `theorem necessary_truth_exists : ∃ τ : Form, □ τ` | {CL}  |
| `normativity_established` | theorem | [L437](formal/Logos/NecessaryPersonalGround.lean#L437) | `theorem normativity_established (hAct : ∃ s : Subject, ∃ p : Prop, Logos.Agency.` | {Initiates, Means, State, Subject, CL}  |
| `ofAtom_ne_ofSubject` | theorem | [L185](formal/Logos/NecessaryPersonalGround.lean#L185) | `theorem ofAtom_ne_ofSubject (n : Nat) (s : Subject) : Entity.ofAtom n ≠ EntityOf` | {Subject} → C128 |
| `ofAtom_not_necessary_entity` | theorem | [L191](formal/Logos/NecessaryPersonalGround.lean#L191) | `theorem ofAtom_not_necessary_entity (n : Nat) : ¬ NecessaryEntity (Entity.ofAtom` | {Subject}  |
| `ofAtom_not_necessary_personal_ground` | theorem | [L347](formal/Logos/NecessaryPersonalGround.lean#L347) | `theorem ofAtom_not_necessary_personal_ground (n : Nat) : ¬ NecessaryPersonalGrou` | {GroundsEntity, Means, Subject, Will, subjectWill} → C129 |
| `person_exists` | theorem | [L457](formal/Logos/NecessaryPersonalGround.lean#L457) | `theorem person_exists (h : ∃ s : Subject, ∃ p : Prop, Logos.Agency.Act s p) : ∃ ` | {AxIntentionalChoice, Initiates, Means, State, Subject}  |
| `personal_nature_iff_person` | axiom | [L78](formal/Logos/NecessaryPersonalGround.lean#L78) | `axiom personal_nature_iff_person (s : Subject) : HasNature s PersonalNature ↔ Pe` | {personal_nature_iff_person, HasNature, Means, Nature, PersonalNature, Subject}  |
| `rational_act_carries_personal` | theorem | [L269](formal/Logos/NecessaryPersonalGround.lean#L269) | `theorem rational_act_carries_personal (s : Subject) (p : Prop) (hAct : Logos.Age` | {Initiates, Means, State, Subject, CL}  |
| `right_wrong_established` | theorem | [L430](formal/Logos/NecessaryPersonalGround.lean#L430) | `theorem right_wrong_established (h : (∃ s : Subject, ∃ p : Prop, Logos.Order.Cor` | {Initiates, Means, State, Subject}  |
| `step1_necessary_truth_exists` | theorem | [L245](formal/Logos/NecessaryPersonalGround.lean#L245) | `theorem step1_necessary_truth_exists : ∃ τ : Form, □ τ` | {CL}  |
| `step2_necessary_reality_exists` | theorem | [L251](formal/Logos/NecessaryPersonalGround.lean#L251) | `theorem step2_necessary_reality_exists : ∃ e : Entity, NecessaryEntity e ∧ ∃ τ :` | {AxGlobalGround, Ground, Subject, CL}  |
| `step3_personal_logical_inseparability` | theorem | [L260](formal/Logos/NecessaryPersonalGround.lean#L260) | `theorem step3_personal_logical_inseparability (a : Prop) (hAct : Logos.Person.Ra` | {Initiates, Means, State, Subject, CL}  |
| `trinitarian_godhead_yields_necessary_person` | theorem | [L565](formal/Logos/NecessaryPersonalGround.lean#L565) | `theorem trinitarian_godhead_yields_necessary_person {G : Entity} (t : Trinitaria` | {divine_nature_is_personal, divine_person_is_necessary, personal_nature_iff_person, DivineNature, GroundsEntity, HasNature, Means, Nature, PersonalNature, Subject, Will, subjectWill}  |
| `trinitarian_persons_are_necessary` | theorem | [L539](formal/Logos/NecessaryPersonalGround.lean#L539) | `theorem trinitarian_persons_are_necessary {G : Entity} (t : TrinitarianGodhead G` | {divine_person_is_necessary, DivineNature, GroundsEntity, HasNature, Means, Nature, Subject, Will, subjectWill}  |
| `trinitarian_persons_are_personal` | theorem | [L527](formal/Logos/NecessaryPersonalGround.lean#L527) | `theorem trinitarian_persons_are_personal {G : Entity} (t : TrinitarianGodhead G)` | {divine_nature_is_personal, personal_nature_iff_person, DivineNature, GroundsEntity, HasNature, Means, Nature, PersonalNature, Subject, Will, subjectWill}  |
| `trinitarian_wills_are_distinct` | theorem | [L552](formal/Logos/NecessaryPersonalGround.lean#L552) | `theorem trinitarian_wills_are_distinct {G : Entity} (t : TrinitarianGodhead G) :` | {DivineNature, GroundsEntity, HasNature, Means, Nature, Subject, Will, subjectWill, will_individuation}  |
| `universal_ground_unique` | axiom | [L487](formal/Logos/NecessaryPersonalGround.lean#L487) | `axiom universal_ground_unique : ∀ {g₁ g₂ : Entity}, GroundsPersonalReality g₁ → ` | {universal_ground_unique, GroundsEntity, Means, Subject, Will, subjectWill}  |
...
| Name | Kind | Line | Statement (logic) | Axioms |
|---|---|---|---|---|
| `AxPersonalNormativeGround` | axiom | [L144](formal/Logos/PersonalNormativeGround.lean#L144) | `axiom AxPersonalNormativeGround : ∀ (s : Subject) (p : Prop), Act s p → FreeInde` | {AxPersonalNormativeGround, GroundProp, Initiates, Means, State, Subject, Will, subjectWill} → C143 |
| `GlobalGroundedNormativePolarity` | def | [L105](formal/Logos/PersonalNormativeGround.lean#L105) | `def GlobalGroundedNormativePolarity : Prop` | {GroundProp, Initiates, Means, State, Subject, Will, subjectWill}  |
| `GroundedNormativePolarity` | def | [L99](formal/Logos/PersonalNormativeGround.lean#L99) | `def GroundedNormativePolarity (s : Subject) : Prop` | {GroundProp, Initiates, Means, State, Subject, Will, subjectWill}  |
| `GroundsJudicativePolarity` | def | [L93](formal/Logos/PersonalNormativeGround.lean#L93) | `def GroundsJudicativePolarity (s : Subject) (p : Prop) : Prop` | {GroundProp, Initiates, Means, State, Subject}  |
| `JudicativeNormativePolarity` | def | [L73](formal/Logos/PersonalNormativeGround.lean#L73) | `def JudicativeNormativePolarity (s : Subject) (p : Prop) : Prop` | {Initiates, Means, State, Subject}  |
| `discovery_independent_of_grounding` | theorem | [L198](formal/Logos/PersonalNormativeGround.lean#L198) | `theorem discovery_independent_of_grounding {s : Subject} {p q : Prop} (hGN : Gen` | {Means, Subject} → C145 |
| `free_independent_will_grounds_judicative_polarity` | theorem | [L154](formal/Logos/PersonalNormativeGround.lean#L154) | `theorem free_independent_will_grounds_judicative_polarity (s : Subject) (p : Pro` | {AxPersonalNormativeGround, GroundProp, Initiates, Means, State, Subject, Will, subjectWill}  |
| `grounding_distinct_from_grounded` | theorem | [L117](formal/Logos/PersonalNormativeGround.lean#L117) | `theorem grounding_distinct_from_grounded (s : Subject) (p : Prop) : EntityOf s ≠` | {Subject}  |
...
| `judicative_normative_polarity_of_act` | theorem | [L79](formal/Logos/PersonalNormativeGround.lean#L79) | `theorem judicative_normative_polarity_of_act (s : Subject) (p : Prop) (hAct : Ac` | {Initiates, Means, State, Subject, CL}  |
| `person_exists_implies_global_grounded_polarity` | theorem | [L182](formal/Logos/PersonalNormativeGround.lean#L182) | `theorem person_exists_implies_global_grounded_polarity (h : ∃ s : Subject, ∃ p :` | {AxPersonalNormativeGround, GroundProp, Initiates, Means, State, Subject, Will, subjectWill, will_individuation}  |
| `person_grounds_normative_polarity` | theorem | [L163](formal/Logos/PersonalNormativeGround.lean#L163) | `theorem person_grounds_normative_polarity (s : Subject) (p : Prop) (hAct : Act s` | {AxPersonalNormativeGround, GroundProp, Initiates, Means, State, Subject, Will, subjectWill, will_individuation} → C144 |
| `person_realizes_grounded_polarity` | theorem | [L172](formal/Logos/PersonalNormativeGround.lean#L172) | `theorem person_realizes_grounded_polarity (s : Subject) (p : Prop) (hAct : Act s` | {AxPersonalNormativeGround, GroundProp, Initiates, Means, State, Subject, Will, subjectWill, will_individuation}  |
| `will_identity_collapses_normativity` | theorem | [L127](formal/Logos/PersonalNormativeGround.lean#L127) | `theorem will_identity_collapses_normativity {s : Subject} (hSelf : SelfLegislati` | {Ought, Subject, Wills}  |
