...
| `State` | A11 | `VOCAB` | Vocabulary: abstract state space for initiation of movement. | C100, C101, C102, C103, C104, C105, C106, C124, C126, C129, C137, C138, C139, C140, C141, C144, C147, C148, C149, C150, C151, C152, C153, C21, C23, C24, C25, C30, C32, C33, C39, C52, C53, C55, C57, C62, C68, C77, C83, C84, C92, C94, C97, C98, C99, F1b |
| `Initiates` | A12 | `VOCAB` | Vocabulary: the initiation relation — a subject initiates a transition between states positing content. | C100, C101, C102, C103, C104, C105, C106, C124, C126, C129, C137, C138, C139, C140, C141, C144, C147, C148, C149, C150, C151, C152, C153, C21, C23, C24, C25, C30, C32, C33, C39, C52, C53, C55, C57, C62, C68, C77, C83, C84, C92, C94, C97, C98, C99, F1b |
...
- GAPMAP claims with a kernel declaration located (FOUND): **132** / 165
- Steps with an **English meaning in code**: **158** / 165 · **no gloss:** C127, C130, C132, C133, C134, C135, C136
...
- **Kernel theorems supporting the architecture (1393 intentional unmapped helper/infrastructure theorems):**
...
| C145 | `Logos.PersonalNormativeGround.discovery_independent_of_grounding` | [PersonalNormativeGround.lean#L197](formal/Logos/PersonalNormativeGround.lean#L197) | `{Means, Subject}` | axiom `Subject` (VOCAB), `Choice.Chooses`, `Choice.FreeWill`, `IndubitableNormativeFreeWill.GenuineNormativity`, **C107** `indubitable_normative_free_will` | — |
| C146 | `Logos.PersonalNormativeGround.HostileModels.model_b_separation` | [PersonalNormativeGround.lean#L284](formal/Logos/PersonalNormativeGround.lean#L284) | `{}` | `PersonalNormativeGround.HostileModels.ModelBSignature`, axiom `GroundProp` (VOCAB), axiom `Subject` (VOCAB) | — |
| C147 | `Logos.PersonalGroundOfReality.deny_right_self_contradicts` | [PersonalGroundOfReality.lean#L44](formal/Logos/PersonalGroundOfReality.lean#L44) | `{Initiates, Means, State, Subject}` | axiom `Subject` (VOCAB), **C102** `NoRight`, **C104** `cannot_claim_correct_no_right_and_true`, `RetorsiveNormativity.ClaimsCorrect` | **C151** `the_person_supports_the_reality_of_right` |
| C148 | `Logos.PersonalGroundOfReality.reality_of_right` | [PersonalGroundOfReality.lean#L50](formal/Logos/PersonalGroundOfReality.lean#L50) | `{Initiates, Means, State, Subject}` | **C36** `rightWrongDistinction`, `IndubitableNormativeFreeWill.EstablishedRightWrong`, `NecessaryPersonalGround.NecessaryNormativeOrder`, `NecessaryPersonalGround.necessary_normative_order` | — |
| C149 | `Logos.PersonalGroundOfReality.judicative_stance_forces_person` | [PersonalGroundOfReality.lean#L58](formal/Logos/PersonalGroundOfReality.lean#L58) | `{Initiates, Means, State, Subject, CL}` | axiom `Subject` (VOCAB), `Choice.Chooses`, `Choice.FreeWill`, `NormativeOrder.ClaimsNormativeCorrectness`, **C140** `claims_normative_correctness_derives_free_will`, `Order.Correct`, `Order.Incorrect`, `Person.Person`, **C120** `free_subject_is_person` | **C152** `personal_ground_of_right_exists`, **C153** `present_act_yields_personal_grounding_of_reality`, **C151** `the_person_supports_the_reality_of_right` |
| C150 | `Logos.PersonalGroundOfReality.every_judicative_act_grounds_its_own_polarity` | [PersonalGroundOfReality.lean#L68](formal/Logos/PersonalGroundOfReality.lean#L68) | `{Initiates, Means, State, Subject, CL}` | `Agency.Act`, axiom `Subject` (VOCAB), `PersonalNormativeGround.GroundsJudicativePolarity`, `PersonalNormativeGround.judicative_normative_polarity_of_act` | **C152** `personal_ground_of_right_exists`, **C151** `the_person_supports_the_reality_of_right` |
| C151 | `Logos.PersonalGroundOfReality.the_person_supports_the_reality_of_right` | [PersonalGroundOfReality.lean#L85](formal/Logos/PersonalGroundOfReality.lean#L85) | `{Initiates, Means, State, Subject, CL}` | `Agency.Act`, axiom `Subject` (VOCAB), **C36** `rightWrongDistinction`, **C102** `NoRight`, `IndubitableNormativeFreeWill.EstablishedRightWrong`, `NecessaryPersonalGround.NecessaryNormativeOrder`, `NecessaryPersonalGround.necessary_normative_order`, `NormativeOrder.ClaimsNormativeCorrectness`, `Person.Person`, **C147** `deny_right_self_contradicts`, **C150** `every_judicative_act_grounds_its_own_polarity`, **C149** `judicative_stance_forces_person`, `PersonalNormativeGround.GroundsJudicativePolarity`, `RetorsiveNormativity.ClaimsCorrect` | — |
| C152 | `Logos.PersonalGroundOfReality.personal_ground_of_right_exists` | [PersonalGroundOfReality.lean#L100](formal/Logos/PersonalGroundOfReality.lean#L100) | `{Initiates, Means, State, Subject, CL}` | `Agency.Act`, axiom `Subject` (VOCAB), `NecessaryPersonalGround.NecessaryNormativeOrder`, `NecessaryPersonalGround.necessary_normative_order`, `NormativeOrder.ClaimsNormativeCorrectness`, `Person.Person`, **C150** `every_judicative_act_grounds_its_own_polarity`, **C149** `judicative_stance_forces_person`, `PersonalNormativeGround.GroundsJudicativePolarity` | — |
| C153 | `Logos.PersonalGroundOfReality.present_act_yields_personal_grounding_of_reality` | [PersonalGroundOfReality.lean#L112](formal/Logos/PersonalGroundOfReality.lean#L112) | `{Initiates, Means, State, Subject, CL}` | `Agency.Act`, axiom `Subject` (VOCAB), `NecessaryPersonalGround.NecessaryNormativeOrder`, `NecessaryPersonalGround.necessary_normative_order`, `NormativeOrder.ClaimsNormativeCorrectness`, `Person.Person`, **C149** `judicative_stance_forces_person`, `PersonalNormativeGround.GroundsJudicativePolarity`, `PersonalNormativeGround.judicative_normative_polarity_of_act` | — |
...
| `C147` | def | [L108](formal/Logos/ClaimMeanings.lean#L108) | `def C147 : String` | —  |
| `C148` | def | [L110](formal/Logos/ClaimMeanings.lean#L110) | `def C148 : String` | —  |
| `C149` | def | [L112](formal/Logos/ClaimMeanings.lean#L112) | `def C149 : String` | —  |
| `C150` | def | [L114](formal/Logos/ClaimMeanings.lean#L114) | `def C150 : String` | —  |
| `C151` | def | [L116](formal/Logos/ClaimMeanings.lean#L116) | `def C151 : String` | —  |
| `C152` | def | [L118](formal/Logos/ClaimMeanings.lean#L118) | `def C152 : String` | —  |
| `C153` | def | [L120](formal/Logos/ClaimMeanings.lean#L120) | `def C153 : String` | —  |
...
| Name | Kind | Line | Statement (logic) | Axioms |
|---|---|---|---|---|
| `deny_right_self_contradicts` | theorem | [L44](formal/Logos/PersonalGroundOfReality.lean#L44) | `theorem deny_right_self_contradicts : ¬ ∃ s : Subject, ClaimsCorrect s NoRight ∧` | {Initiates, Means, State, Subject} → C147 |
| `direction_stack` | def | [L121](formal/Logos/PersonalGroundOfReality.lean#L121) | `def direction_stack : List (String × String)` | {}  |
| `every_judicative_act_grounds_its_own_polarity` | theorem | [L68](formal/Logos/PersonalGroundOfReality.lean#L68) | `theorem every_judicative_act_grounds_its_own_polarity : ∀ (s : Subject) (q : Pro` | {Initiates, Means, State, Subject, CL} → C150 |
| `free_subject_grounds_normative_order` | theorem | [L35](formal/Logos/PersonalGroundOfReality.lean#L35) | `theorem free_subject_grounds_normative_order {s : Subject} {p : Prop} (hClaims :` | {Initiates, Means, State, Subject, CL}  |
| `judicative_stance_forces_person` | theorem | [L58](formal/Logos/PersonalGroundOfReality.lean#L58) | `theorem judicative_stance_forces_person : ∀ (s : Subject) (p : Prop), ClaimsNorm` | {Initiates, Means, State, Subject, CL} → C149 |
| `personal_ground_of_right_exists` | theorem | [L100](formal/Logos/PersonalGroundOfReality.lean#L100) | `theorem personal_ground_of_right_exists (hDatum : ∃ s : Subject, ∃ p : Prop, Cla` | {Initiates, Means, State, Subject, CL} → C152 |
| `present_act_yields_personal_grounding_of_reality` | theorem | [L112](formal/Logos/PersonalGroundOfReality.lean#L112) | `theorem present_act_yields_personal_grounding_of_reality {s : Subject} {p : Prop` | {Initiates, Means, State, Subject, CL} → C153 |
| `reality_of_right` | theorem | [L50](formal/Logos/PersonalGroundOfReality.lean#L50) | `theorem reality_of_right : EstablishedRightWrong ∧ NecessaryNormativeOrder` | {Initiates, Means, State, Subject} → C148 |
| `the_person_supports_the_reality_of_right` | theorem | [L85](formal/Logos/PersonalGroundOfReality.lean#L85) | `theorem the_person_supports_the_reality_of_right : (¬ ∃ s : Subject, ClaimsCorre` | {Initiates, Means, State, Subject, CL} → C151 |
...
| `discovery_independent_of_grounding` | theorem | [L197](formal/Logos/PersonalNormativeGround.lean#L197) | `theorem discovery_independent_of_grounding {s : Subject} {p q : Prop} (hGN : Gen` | {Means, Subject} → C145 |
...
| `judicative_discovery_independent_of_grounding` | theorem | [L207](formal/Logos/PersonalNormativeGround.lean#L207) | `theorem judicative_discovery_independent_of_grounding {s : Subject} {p : Prop} (` | {Initiates, Means, State, Subject, CL}  |
...
| Name | Kind | Line | Statement (logic) | Axioms |
|---|---|---|---|---|
| `ModelASignature` | structure | [L219](formal/Logos/PersonalNormativeGround.lean#L219) | `structure ModelASignature where` | —  |
| `ModelBSignature` | structure | [L247](formal/Logos/PersonalNormativeGround.lean#L247) | `structure ModelBSignature where` | —  |
| `model_a_satisfiable` | theorem | [L232](formal/Logos/PersonalNormativeGround.lean#L232) | `theorem model_a_satisfiable : ∃ M : ModelASignature, True` | {}  |
| `model_b_satisfiable` | theorem | [L264](formal/Logos/PersonalNormativeGround.lean#L264) | `theorem model_b_satisfiable : ∃ M : ModelBSignature, True` | {}  |
| `model_b_separation` | theorem | [L284](formal/Logos/PersonalNormativeGround.lean#L284) | `theorem model_b_separation (M : ModelBSignature) : (∃ s : M.Subject, M.FreeIndep` | {} → C146 |
| `model_c_self_legislation_collapses` | theorem | [L295](formal/Logos/PersonalNormativeGround.lean#L295) | `theorem model_c_self_legislation_collapses {s : Subject} (hSelf : SelfLegislatio` | {Ought, Subject, Wills}  |
