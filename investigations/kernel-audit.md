...
- Steps with an **English meaning in code**: **160** / 163 · **no gloss:** C88, C77, C92
- **Claims whose referenced theorem is missing (MISSING) (2):**
  - `C77` ref `Love.necessaryPersonExists_conditional` — P5/P8
  - `C92` ref `Love.necessary_entity_exists_conditional` — P8/§27
...
- **Kernel theorems supporting the architecture (1226 intentional unmapped helper/infrastructure theorems):**
...
- **Kernel × GAPMAP footprint divergences** (5 — fix the GAPMAP ledger):
...
| C16 | `Logos.Entity.lawExcludedMiddle` | [Entity.lean#L90](formal/Logos/Entity.lean#L90) | `{CL}` | `Entity.NecessarilyTrue`, `Entity.TrueAt`, `Semantics.Form`, `Semantics.World` | — |
| C17 | `Logos.Entity.nonContradiction` | [Entity.lean#L98](formal/Logos/Entity.lean#L98) | `{}` | `Entity.NecessarilyFalse`, `Entity.TrueAt`, `Semantics.Form`, `Semantics.Satisfies`, `Semantics.World` | — |
...
| F6 | — | — | — | — | — |
| Q7.2 | `Logos.Entity.ExistsAt` | [Entity.lean#L44](formal/Logos/Entity.lean#L44) | `{Subject}` | `Entity.Entity`, `Entity.EntityExistsAt`, `Semantics.World` | **C44** `T14_world_conditional`, `Modal.NecessaryEntity`, `NecessaryPersonalGround.ActualEntity`, `Plurality.NecessarySubject`, `RecoveredOntologicalGround.ActualEntity`, `RecoveredOntologicalGround.contingent_subject_ne_necessary_entity`, `RecoveredOntologicalGround.ground_of_reality_grounds_finite_subject`, `RecoveredOntologicalGround.ground_of_reality_not_impersonal`, `RecoveredOntologicalGround.subject_exists_at_actualWorld`, `TheologicalModalHardening.ActualEntity`, `TheologicalModalHardening.ContingentEntity`, `TheologicalModalHardening.NecessaryEntity`, `TheologicalModalHardening.necessary_not_contingent` |
...
| Name | Kind | Line | Statement (logic) | Axioms |
|---|---|---|---|---|
| `C102` | def | [L72](formal/Logos/ClaimMeanings.lean#L72) | `def C102 : String` | —  |
| `C103` | def | [L74](formal/Logos/ClaimMeanings.lean#L74) | `def C103 : String` | —  |
| `C104` | def | [L76](formal/Logos/ClaimMeanings.lean#L76) | `def C104 : String` | —  |
| `C105` | def | [L78](formal/Logos/ClaimMeanings.lean#L78) | `def C105 : String` | —  |
| `C106` | def | [L80](formal/Logos/ClaimMeanings.lean#L80) | `def C106 : String` | —  |
| `C107` | def | [L82](formal/Logos/ClaimMeanings.lean#L82) | `def C107 : String` | —  |
| `C108` | def | [L84](formal/Logos/ClaimMeanings.lean#L84) | `def C108 : String` | —  |
| `C109` | def | [L86](formal/Logos/ClaimMeanings.lean#L86) | `def C109 : String` | —  |
| `C110` | def | [L88](formal/Logos/ClaimMeanings.lean#L88) | `def C110 : String` | —  |
| `C111` | def | [L90](formal/Logos/ClaimMeanings.lean#L90) | `def C111 : String` | —  |
| `C112` | def | [L92](formal/Logos/ClaimMeanings.lean#L92) | `def C112 : String` | —  |
| `C142` | def | [L94](formal/Logos/ClaimMeanings.lean#L94) | `def C142 : String` | —  |
| `C143` | def | [L96](formal/Logos/ClaimMeanings.lean#L96) | `def C143 : String` | —  |
| `C144` | def | [L98](formal/Logos/ClaimMeanings.lean#L98) | `def C144 : String` | —  |
| `C145` | def | [L100](formal/Logos/ClaimMeanings.lean#L100) | `def C145 : String` | —  |
| `C146` | def | [L102](formal/Logos/ClaimMeanings.lean#L102) | `def C146 : String` | —  |
| `C147` | def | [L104](formal/Logos/ClaimMeanings.lean#L104) | `def C147 : String` | —  |
| `C148` | def | [L106](formal/Logos/ClaimMeanings.lean#L106) | `def C148 : String` | —  |
| `C149` | def | [L108](formal/Logos/ClaimMeanings.lean#L108) | `def C149 : String` | —  |
| `C150` | def | [L110](formal/Logos/ClaimMeanings.lean#L110) | `def C150 : String` | —  |
| `C151` | def | [L112](formal/Logos/ClaimMeanings.lean#L112) | `def C151 : String` | —  |
| `C152` | def | [L114](formal/Logos/ClaimMeanings.lean#L114) | `def C152 : String` | —  |
| `C153` | def | [L116](formal/Logos/ClaimMeanings.lean#L116) | `def C153 : String` | —  |
| `C64` | def | [L58](formal/Logos/ClaimMeanings.lean#L58) | `def C64 : String` | —  |
| `C65` | def | [L60](formal/Logos/ClaimMeanings.lean#L60) | `def C65 : String` | —  |
| `C66` | def | [L62](formal/Logos/ClaimMeanings.lean#L62) | `def C66 : String` | —  |
| `C67` | def | [L64](formal/Logos/ClaimMeanings.lean#L64) | `def C67 : String` | —  |
...
| `C80` | def | [L66](formal/Logos/ClaimMeanings.lean#L66) | `def C80 : String` | —  |
| `C81` | def | [L68](formal/Logos/ClaimMeanings.lean#L68) | `def C81 : String` | —  |
| `C82` | def | [L70](formal/Logos/ClaimMeanings.lean#L70) | `def C82 : String` | —  |
...
| Name | Kind | Line | Statement (logic) | Axioms |
|---|---|---|---|---|
| `Entity` | inductive | [L19](formal/Logos/Entity.lean#L19) | `inductive Entity : Type` | —  |
| `EntityExistsAt` | def | [L39](formal/Logos/Entity.lean#L39) | `def EntityExistsAt (w : World) : Entity → Prop | Entity.ofSubject s => SubjectEx` | {Subject}  |
| `EntityOf` | def | [L24](formal/Logos/Entity.lean#L24) | `def EntityOf (s : Subject) : Entity` | {Subject}  |
| `ExistsAt` | def | [L44](formal/Logos/Entity.lean#L44) | `def ExistsAt (w : World) (e : Entity) : Prop` | {Subject} → Q7.2 |
| `NecessarilyFalse` | def | [L53](formal/Logos/Entity.lean#L53) | `def ¬◇(φ : Form) : Prop` | {}  |
| `NecessarilyTrue` | def | [L50](formal/Logos/Entity.lean#L50) | `def □(φ : Form) : Prop` | {}  |
| `SubjectExistsAt` | def | [L33](formal/Logos/Entity.lean#L33) | `def SubjectExistsAt (w : World) (_s : Subject) : Prop` | {Subject}  |
| `TrueAt` | def | [L47](formal/Logos/Entity.lean#L47) | `def TrueAt (w : World) (φ : Form) : Prop` | {}  |
| `actualWorld` | def | [L29](formal/Logos/Entity.lean#L29) | `def actualWorld : World` | {}  |
| `lawExcludedMiddle` | theorem | [L90](formal/Logos/Entity.lean#L90) | `theorem lawExcludedMiddle (φ : Form) : □(φ ∨ ¬φ)` | {CL} → C16 |
| `nonContradiction` | theorem | [L98](formal/Logos/Entity.lean#L98) | `theorem nonContradiction (φ : Form) : ¬◇(φ ∧ ¬φ)` | {} → C17 |
| `sat_and` | theorem | [L62](formal/Logos/Entity.lean#L62) | `theorem sat_and {w : World} {φ ψ : Form} : w ⊨ (φ ∧ ψ) ↔ w ⊨ φ ∧ w ⊨ ψ` | {}  |
| `sat_ground_and` | theorem | [L77](formal/Logos/Entity.lean#L77) | `theorem sat_ground_and {w : World} {φ ψ : Form} : w ⊨ (φ ∧ ψ) ↔ w ⊨ φ ∧ w ⊨ ψ` | {}  |
| `sat_ground_imp` | theorem | [L83](formal/Logos/Entity.lean#L83) | `theorem sat_ground_imp {w : World} {φ ψ : Form} : w ⊨ (φ → ψ) ↔ (w ⊨ φ → w ⊨ ψ)` | {}  |
| `sat_ground_not` | theorem | [L80](formal/Logos/Entity.lean#L80) | `theorem sat_ground_not {w : World} {φ : Form} : w ⊨ ¬φ ↔ ¬ w ⊨ φ` | {}  |
| `sat_ground_or` | theorem | [L74](formal/Logos/Entity.lean#L74) | `theorem sat_ground_or {w : World} {φ ψ : Form} : w ⊨ (φ ∨ ψ) ↔ w ⊨ φ ∨ w ⊨ ψ` | {}  |
| `sat_imp` | theorem | [L70](formal/Logos/Entity.lean#L70) | `theorem sat_imp {w : World} {φ ψ : Form} : w ⊨ (φ → ψ) ↔ (w ⊨ φ → w ⊨ ψ)` | {}  |
| `sat_not` | theorem | [L66](formal/Logos/Entity.lean#L66) | `theorem sat_not {w : World} {φ : Form} : w ⊨ ¬φ ↔ ¬ w ⊨ φ` | {}  |
| `sat_or` | theorem | [L58](formal/Logos/Entity.lean#L58) | `theorem sat_or {w : World} {φ ψ : Form} : w ⊨ (φ ∨ ψ) ↔ w ⊨ φ ∨ w ⊨ ψ` | {}  |
...
| `EntityMeans` | def | [L147](formal/Logos/NecessaryPersonalGround.lean#L147) | `def EntityMeans (e : Entity) (p : Prop) : Prop` | {Means, Subject}  |
...
| `atom_cannot_ground_intentional_subject` | theorem | [L161](formal/Logos/NecessaryPersonalGround.lean#L161) | `theorem atom_cannot_ground_intentional_subject (n : Nat) (s : Subject) (p : Prop` | {Means, Subject}  |
| `atom_cannot_ground_person` | theorem | [L174](formal/Logos/NecessaryPersonalGround.lean#L174) | `theorem atom_cannot_ground_person (n : Nat) (s : Subject) (hPerson : Person s) :` | {Means, Subject}  |
| `de_dicto_not_implies_de_re` | theorem | [L258](formal/Logos/NecessaryPersonalGround.lean#L258) | `theorem de_dicto_not_implies_de_re : ∃ (W : Type) (S : Type) (ExistsAt : W → S →` | {}  |
| `established_normative_person` | theorem | [L234](formal/Logos/NecessaryPersonalGround.lean#L234) | `theorem established_normative_person (hClaims : ∃ s : Subject, ∃ p : Prop, Logos` | {Initiates, Means, State, Subject, Will, subjectWill, CL}  |
| `established_will_reality` | theorem | [L216](formal/Logos/NecessaryPersonalGround.lean#L216) | `theorem established_will_reality (hAssert : ∃ s : Subject, ∃ p : Prop, Logos.Age` | {AxIntentionalChoice, Initiates, Means, State, Subject, Will, subjectWill}  |
...
| `necessary_truth_exists` | theorem | [L248](formal/Logos/NecessaryPersonalGround.lean#L248) | `theorem necessary_truth_exists : ∃ τ : Form, □ τ` | {CL}  |
...
| `rational_act_carries_personal` | theorem | [L201](formal/Logos/NecessaryPersonalGround.lean#L201) | `theorem rational_act_carries_personal (s : Subject) (p : Prop) (hAct : Logos.Age` | {Initiates, Means, State, Subject, CL}  |
| `step1_necessary_truth_exists` | theorem | [L186](formal/Logos/NecessaryPersonalGround.lean#L186) | `theorem step1_necessary_truth_exists : ∃ τ : Form, □ τ` | {CL}  |
| `step3_personal_logical_inseparability` | theorem | [L192](formal/Logos/NecessaryPersonalGround.lean#L192) | `theorem step3_personal_logical_inseparability (a : Prop) (hAct : Logos.Person.Ra` | {Initiates, Means, State, Subject, CL}  |
...
| Name | Kind | Line | Statement (logic) | Axioms |
|---|---|---|---|---|
| `ForcedGroundContent` | def | [L528](formal/Logos/PersonalNormativeGround.lean#L528) | `def ForcedGroundContent (s : Subject) : Prop` | {Means, Subject}  |
| `GlobalGroundedNormativePolarity` | def | [L238](formal/Logos/PersonalNormativeGround.lean#L238) | `def GlobalGroundedNormativePolarity : Prop` | {Means, Subject, Will, subjectWill}  |
| `GroundedNormativePolarity` | def | [L230](formal/Logos/PersonalNormativeGround.lean#L230) | `def GroundedNormativePolarity (s : Subject) : Prop` | {Means, Subject, Will, subjectWill}  |
| `GroundsJudicativePolarity` | def | [L223](formal/Logos/PersonalNormativeGround.lean#L223) | `def GroundsJudicativePolarity (s : Subject) (p : Prop) : Prop` | {Means, Subject}  |
...
| `GroundsRightWrongAt` | structure | [L216](formal/Logos/PersonalNormativeGround.lean#L216) | `structure GroundsRightWrongAt (s : Subject) (p q : Prop) : Prop where` | —  |
...
| `PersonalGroundExists` | def | [L492](formal/Logos/PersonalNormativeGround.lean#L492) | `def PersonalGroundExists : Prop` | {Means, Subject}  |
...
| `Stage0_NormativeDatum` | def | [L275](formal/Logos/PersonalNormativeGround.lean#L275) | `def Stage0_NormativeDatum (s : Subject) (p q : Prop) : Prop` | {Subject}  |
| `Stage1_NormativeStance` | def | [L281](formal/Logos/PersonalNormativeGround.lean#L281) | `def Stage1_NormativeStance (s : Subject) (p q : Prop) : Prop` | {Means, Subject}  |
| `Stage2_NormativeChoice` | def | [L286](formal/Logos/PersonalNormativeGround.lean#L286) | `def Stage2_NormativeChoice (s : Subject) (p q : Prop) : Prop` | {Means, Subject}  |
| `Stage3_AgentialFreeWill` | def | [L291](formal/Logos/PersonalNormativeGround.lean#L291) | `def Stage3_AgentialFreeWill (s : Subject) : Prop` | {Means, Subject}  |
| `Stage4_FreeSubject` | def | [L296](formal/Logos/PersonalNormativeGround.lean#L296) | `def Stage4_FreeSubject (s : Subject) : Prop` | {Means, Subject}  |
| `Stage5_Person` | def | [L302](formal/Logos/PersonalNormativeGround.lean#L302) | `def Stage5_Person (s : Subject) : Prop` | {Means, Subject}  |
| `Stage6_PersonalGrounding` | def | [L422](formal/Logos/PersonalNormativeGround.lean#L422) | `def Stage6_PersonalGrounding (s : Subject) : Prop` | {Means, Subject}  |
| `discovery_independent_of_grounding` | theorem | [L586](formal/Logos/PersonalNormativeGround.lean#L586) | `theorem discovery_independent_of_grounding {s : Subject} {p q : Prop} (hGN : Gen` | {Means, Subject} → C145 |
| `discovery_rightwrong_to_person` | theorem | [L353](formal/Logos/PersonalNormativeGround.lean#L353) | `theorem discovery_rightwrong_to_person (s : Subject) (h : RightWrong s) : Person` | {Means, Subject}  |
| `existential_forward_normative_grounding` | theorem | [L482](formal/Logos/PersonalNormativeGround.lean#L482) | `theorem existential_forward_normative_grounding (hDatum : ∃ s : Subject, ∃ p q :` | {Means, Subject}  |
| `forced_content_of_person` | theorem | [L553](formal/Logos/PersonalNormativeGround.lean#L553) | `theorem forced_content_of_person (s : Subject) (hPerson : Person s) : ForcedGrou` | {Means, Subject} → C169 |
| `forward_composition_pipeline` | theorem | [L458](formal/Logos/PersonalNormativeGround.lean#L458) | `theorem forward_composition_pipeline (s : Subject) (p q : Prop) : RightWrongAt s` | {Means, Subject}  |
| `forward_discovery_person` | theorem | [L343](formal/Logos/PersonalNormativeGround.lean#L343) | `theorem forward_discovery_person (s : Subject) (p q : Prop) (h0 : RightWrongAt s` | {Means, Subject}  |
| `forward_modus_ponens_derivation` | theorem | [L443](formal/Logos/PersonalNormativeGround.lean#L443) | `theorem forward_modus_ponens_derivation (s : Subject) (p q : Prop) (h0 : RightWr` | {Means, Subject} → C154 |
| `free_independent_will_grounds_judicative_polarity` | theorem | [L391](formal/Logos/PersonalNormativeGround.lean#L391) | `theorem free_independent_will_grounds_judicative_polarity (s : Subject) (hFW : F` | {Means, Subject, Will, subjectWill, will_individuation}  |
| `grounding_distinct_from_grounded` | theorem | [L250](formal/Logos/PersonalNormativeGround.lean#L250) | `theorem grounding_distinct_from_grounded (s : Subject) (p : Prop) : EntityOf s ≠` | {Subject}  |
| `grounding_forced_at_datum` | theorem | [L571](formal/Logos/PersonalNormativeGround.lean#L571) | `theorem grounding_forced_at_datum (s : Subject) (p q : Prop) (h0 : RightWrongAt ` | {Means, Subject} → C171 |
| `grounding_forced_by_preceding_facts` | theorem | [L561](formal/Logos/PersonalNormativeGround.lean#L561) | `theorem grounding_forced_by_preceding_facts (s : Subject) (p q : Prop) (h0 : Rig` | {Means, Subject} → C170 |
| `groundsRightWrong_iff_forced_content` | theorem | [L536](formal/Logos/PersonalNormativeGround.lean#L536) | `theorem groundsRightWrong_iff_forced_content (s : Subject) : GroundsRightWrong s` | {Means, Subject} → C168 |
| `judicative_discovery_independent_of_grounding` | theorem | [L595](formal/Logos/PersonalNormativeGround.lean#L595) | `theorem judicative_discovery_independent_of_grounding {s : Subject} {p : Prop} (` | {Initiates, Means, State, Subject, CL}  |
...
| `non_reversal_discovery_and_grounding` | theorem | [L514](formal/Logos/PersonalNormativeGround.lean#L514) | `theorem non_reversal_discovery_and_grounding (s : Subject) (p q : Prop) : (Right` | {Means, Subject} → C156 |
| `person_exists_implies_global_grounded_polarity` | theorem | [L410](formal/Logos/PersonalNormativeGround.lean#L410) | `theorem person_exists_implies_global_grounded_polarity (h : ∃ s : Subject, Perso` | {Means, Subject, Will, subjectWill, will_individuation}  |
| `person_grounds_normative_polarity` | theorem | [L384](formal/Logos/PersonalNormativeGround.lean#L384) | `theorem person_grounds_normative_polarity (s : Subject) (hPerson : Person s) : G` | {Means, Subject} → C144 |
| `person_grounds_original_normative_datum` | theorem | [L470](formal/Logos/PersonalNormativeGround.lean#L470) | `theorem person_grounds_original_normative_datum (s : Subject) (p q : Prop) (h0 :` | {Means, Subject} → C155 |
| `person_grounds_right_wrong` | theorem | [L372](formal/Logos/PersonalNormativeGround.lean#L372) | `theorem person_grounds_right_wrong (s : Subject) (hPerson : Person s) : GroundsR` | {Means, Subject}  |
| `person_realizes_grounded_polarity` | theorem | [L400](formal/Logos/PersonalNormativeGround.lean#L400) | `theorem person_realizes_grounded_polarity (s : Subject) (hPerson : Person s) : G` | {Means, Subject, Will, subjectWill, will_individuation}  |
| `personal_ground_exists_of_datum` | theorem | [L499](formal/Logos/PersonalNormativeGround.lean#L499) | `theorem personal_ground_exists_of_datum (hDatum : ∃ s : Subject, ∃ p q : Prop, R` | {Means, Subject}  |
...
| `step_choice_to_freewill` | theorem | [L322](formal/Logos/PersonalNormativeGround.lean#L322) | `theorem step_choice_to_freewill (s : Subject) (p q : Prop) (h2 : Stage2_Normativ` | {Means, Subject}  |
| `step_datum_to_stance` | theorem | [L308](formal/Logos/PersonalNormativeGround.lean#L308) | `theorem step_datum_to_stance (s : Subject) (p q : Prop) (h0 : Stage0_NormativeDa` | {Means, Subject}  |
| `step_freeSubject_to_person` | theorem | [L336](formal/Logos/PersonalNormativeGround.lean#L336) | `theorem step_freeSubject_to_person (s : Subject) (h4 : Stage4_FreeSubject s) : S` | {Means, Subject}  |
| `step_freewill_to_freeSubject` | theorem | [L329](formal/Logos/PersonalNormativeGround.lean#L329) | `theorem step_freewill_to_freeSubject (s : Subject) (h3 : Stage3_AgentialFreeWill` | {Means, Subject}  |
| `step_person_to_grounding` | theorem | [L430](formal/Logos/PersonalNormativeGround.lean#L430) | `theorem step_person_to_grounding (s : Subject) (hp : Stage5_Person s) : Stage6_P` | {Means, Subject}  |
| `step_stance_to_choice` | theorem | [L315](formal/Logos/PersonalNormativeGround.lean#L315) | `theorem step_stance_to_choice (s : Subject) (p q : Prop) (h1 : Stage1_NormativeS` | {Means, Subject}  |
| `will_identity_collapses_normativity` | theorem | [L260](formal/Logos/PersonalNormativeGround.lean#L260) | `theorem will_identity_collapses_normativity {s : Subject} (hSelf : SelfLegislati` | {Ought, Subject, Wills}  |
...
| Name | Kind | Line | Statement (logic) | Axioms |
|---|---|---|---|---|
| `ModelASignature` | structure | [L607](formal/Logos/PersonalNormativeGround.lean#L607) | `structure ModelASignature where` | —  |
| `ModelBSignature` | structure | [L635](formal/Logos/PersonalNormativeGround.lean#L635) | `structure ModelBSignature where` | —  |
| `model_a_satisfiable` | theorem | [L620](formal/Logos/PersonalNormativeGround.lean#L620) | `theorem model_a_satisfiable : ∃ M : ModelASignature, True` | {}  |
| `model_b_satisfiable` | theorem | [L652](formal/Logos/PersonalNormativeGround.lean#L652) | `theorem model_b_satisfiable : ∃ M : ModelBSignature, True` | {}  |
| `model_b_separation` | theorem | [L672](formal/Logos/PersonalNormativeGround.lean#L672) | `theorem model_b_separation (M : ModelBSignature) : (∃ s : M.Subject, M.FreeIndep` | {} → C146 |
| `model_c_self_legislation_collapses` | theorem | [L683](formal/Logos/PersonalNormativeGround.lean#L683) | `theorem model_c_self_legislation_collapses {s : Subject} (hSelf : SelfLegislatio` | {Ought, Subject, Wills}  |
...
| `EntityMeans` | def | [L42](formal/Logos/RecoveredOntologicalGround.lean#L42) | `def EntityMeans (e : Entity) (p : Prop) : Prop` | {Means, Subject}  |
| `GroundOfReality` | def | [L85](formal/Logos/RecoveredOntologicalGround.lean#L85) | `def GroundOfReality (g : Entity) : Prop` | {Means, Subject}  |
| `GroundsEntity` | def | [L52](formal/Logos/RecoveredOntologicalGround.lean#L52) | `def GroundsEntity (g e : Entity) : Prop` | {Means, Subject}  |
| `ImpersonalEntity` | def | [L39](formal/Logos/RecoveredOntologicalGround.lean#L39) | `def ImpersonalEntity (e : Entity) : Prop` | {Subject}  |
| `NecessaryGroundOfReality` | structure | [L89](formal/Logos/RecoveredOntologicalGround.lean#L89) | `structure NecessaryGroundOfReality (g : Entity) : Prop where` | —  |
| `atom_cannot_ground_person` | theorem | [L69](formal/Logos/RecoveredOntologicalGround.lean#L69) | `theorem atom_cannot_ground_person (n : Nat) (s : Subject) (hPers : Person s) : ¬` | {Means, Subject}  |
| `contingent_subject_ne_necessary_entity` | theorem | [L115](formal/Logos/RecoveredOntologicalGround.lean#L115) | `theorem contingent_subject_ne_necessary_entity (s : Subject) (hCont : ∃ w : Worl` | {Subject}  |
| `explanatory_adequacy` | theorem | [L63](formal/Logos/RecoveredOntologicalGround.lean#L63) | `theorem explanatory_adequacy (g e : Entity) (hGr : GroundsEntity g e) (p : Prop)` | {Means, Subject}  |
| `ground_of_reality_grounds_finite_subject` | theorem | [L125](formal/Logos/RecoveredOntologicalGround.lean#L125) | `theorem ground_of_reality_grounds_finite_subject (g : Entity) (hg : NecessaryGro` | {Means, Subject}  |
| `ground_of_reality_not_impersonal` | theorem | [L144](formal/Logos/RecoveredOntologicalGround.lean#L144) | `theorem ground_of_reality_not_impersonal (g : Entity) (hg : NecessaryGroundOfRea` | {Means, Subject}  |
| `is` | theorem | [L103](formal/Logos/RecoveredOntologicalGround.lean#L103) | `theorem is the constitutive claim in `Logos.PersonalGroundOfReality`. -/` | —  |
| `ofAtom_ne_ofSubject` | theorem | [L56](formal/Logos/RecoveredOntologicalGround.lean#L56) | `theorem ofAtom_ne_ofSubject (n : Nat) (s : Subject) : Entity.ofAtom n ≠ EntityOf` | {Subject}  |
| `rational_act_carries_personal_feature` | theorem | [L155](formal/Logos/RecoveredOntologicalGround.lean#L155) | `theorem rational_act_carries_personal_feature (s : Subject) (p : Prop) (hAct : A` | {Initiates, Means, State, Subject, CL}  |
| `subject_exists_at_actualWorld` | theorem | [L110](formal/Logos/RecoveredOntologicalGround.lean#L110) | `theorem subject_exists_at_actualWorld (s : Subject) : ExistsAt actualWorld (Enti` | {Subject}  |
