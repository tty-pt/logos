...
- GAPMAP claims with a kernel declaration located (FOUND): **139** / 166
- Steps with an **English meaning in code**: **166** / 166
...
- **Kernel theorems supporting the architecture (1274 intentional unmapped helper/infrastructure theorems):**
...
| F2 | — | — | — | — | — |
| F3 | `Logos.MoralFrontierAudit.epistemic_normativity_without_practical_obligation` | [MoralFrontierAudit.lean#L163](formal/Logos/MoralFrontierAudit.lean#L163) | `{}` | `MoralFrontierAudit.M_amoral.OughtStar`, `MoralFrontierAudit.M_amoral.RightWrongStar`, `MoralFrontierAudit.M_amoral.S`, `MoralFrontierAudit.M_amoral.amoral_model_has_no_practical_obligation`, `MoralFrontierAudit.M_amoral.amoral_model_satisfies_epistemic_agential_normativity`, `OughtRetorsion.PracticalAction` | — |
...
| Name | Kind | Line | Statement (logic) | Axioms |
|---|---|---|---|---|
| `ClaimsMoralRectitude` | def | [L209](formal/Logos/MoralFrontierAudit.lean#L209) | `def ClaimsMoralRectitude (s : Subject) (a : PracticalAction) : Prop` | {Evil, Good, Initiates, Means, State, Subject}  |
| `Evil` | axiom | [L203](formal/Logos/MoralFrontierAudit.lean#L203) | `axiom Evil : Subject → Prop → Prop` | {Evil, Subject}  |
| `Good` | axiom | [L187](formal/Logos/MoralFrontierAudit.lean#L187) | `axiom Good : Subject → Prop → Prop` | {Good, Subject}  |
| `epistemic_normativity_without_practical_obligation` | theorem | [L163](formal/Logos/MoralFrontierAudit.lean#L163) | `theorem epistemic_normativity_without_practical_obligation : (∃ s : M_amoral.S, ` | {} → C175 |
| `moral_pole_postulate_is_not_a_consequence` | theorem | [L222](formal/Logos/MoralFrontierAudit.lean#L222) | `theorem moral_pole_postulate_is_not_a_consequence : ∃ G E : Subject → Prop → Pro` | {Initiates, Means, State, Subject}  |
| `stance_exhibits_moral_poles` | theorem | [L215](formal/Logos/MoralFrontierAudit.lean#L215) | `theorem stance_exhibits_moral_poles (s : Subject) (a : PracticalAction) (h : Cla` | {Evil, Good, Initiates, Means, State, Subject}  |

### `Logos.MoralFrontierAudit.M_amoral`

| Name | Kind | Line | Statement (logic) | Axioms |
|---|---|---|---|---|
| `Act` | def | [L73](formal/Logos/MoralFrontierAudit.lean#L73) | `def Act (s : S) (p : Prop) : Prop` | {}  |
| `AmoralistThesis` | def | [L92](formal/Logos/MoralFrontierAudit.lean#L92) | `def AmoralistThesis : Prop` | {}  |
| `CorrectStar` | def | [L76](formal/Logos/MoralFrontierAudit.lean#L76) | `def CorrectStar (s : S) (p : Prop) : Prop` | {}  |
| `GenuineNormativityStar` | def | [L85](formal/Logos/MoralFrontierAudit.lean#L85) | `def GenuineNormativityStar (s : S) (p q : Prop) : Prop` | {}  |
| `IncorrectStar` | def | [L79](formal/Logos/MoralFrontierAudit.lean#L79) | `def IncorrectStar (s : S) (p : Prop) : Prop` | {}  |
| `Initiates` | def | [L70](formal/Logos/MoralFrontierAudit.lean#L70) | `def Initiates (_s : S) (_w _w' : State) (_p : Prop) : Prop` | {}  |
| `Means` | def | [L64](formal/Logos/MoralFrontierAudit.lean#L64) | `def Means (_s : S) (_p : Prop) : Prop` | {}  |
| `OughtStar` | def | [L82](formal/Logos/MoralFrontierAudit.lean#L82) | `def OughtStar (_r _s : S) (_a : PracticalAction) : Prop` | {}  |
| `RightWrongStar` | def | [L89](formal/Logos/MoralFrontierAudit.lean#L89) | `def RightWrongStar (s : S) : Prop` | {}  |
| `S` | abbrev | [L58](formal/Logos/MoralFrontierAudit.lean#L58) | `abbrev S : Type` | {}  |
| `State` | def | [L67](formal/Logos/MoralFrontierAudit.lean#L67) | `def State : Type` | {}  |
| `amoral_disconnection_is_judgeable_as_correct` | theorem | [L137](formal/Logos/MoralFrontierAudit.lean#L137) | `theorem amoral_disconnection_is_judgeable_as_correct : ∃ s : S, CorrectStar s Am` | {}  |
| `amoral_model_has_no_practical_obligation` | theorem | [L111](formal/Logos/MoralFrontierAudit.lean#L111) | `theorem amoral_model_has_no_practical_obligation : ¬ ∃ r : S, ∃ s : S, ∃ a : Pra` | {}  |
| `amoral_model_satisfies_epistemic_agential_normativity` | theorem | [L105](formal/Logos/MoralFrontierAudit.lean#L105) | `theorem amoral_model_satisfies_epistemic_agential_normativity : ∃ s : S, RightWr` | {}  |
| `amoral_model_separation` | theorem | [L122](formal/Logos/MoralFrontierAudit.lean#L122) | `theorem amoral_model_separation : (∃ s : S, RightWrongStar s) ∧ (¬ ∃ r : S, ∃ s ` | {}  |
| `amoralist_consistent_with_reality_hook` | theorem | [L145](formal/Logos/MoralFrontierAudit.lean#L145) | `theorem amoralist_consistent_with_reality_hook : AmoralistThesis ∧ (∃ s : S, Rig` | {}  |
| `amoralist_thesis_true_in_model` | theorem | [L128](formal/Logos/MoralFrontierAudit.lean#L128) | `theorem amoralist_thesis_true_in_model : AmoralistThesis` | {}  |
| `correct_star_tracks_reality` | theorem | [L100](formal/Logos/MoralFrontierAudit.lean#L100) | `theorem correct_star_tracks_reality (s : S) (p : Prop) (h : CorrectStar s p) : p` | {}  |
| `soleSubject` | def | [L61](formal/Logos/MoralFrontierAudit.lean#L61) | `def soleSubject : S` | {}  |
