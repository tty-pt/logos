...
|---|---|---|---|---|
| `Subject` | A1 | `VOCAB` | Vocabulary: the pure sort of subjects — that which performs acts of reasoning. | C100, C101, C102, C103, C104, C105, C106, C107, C113, C114, C116, C117, C118, C119, C120, C121, C122, C137, C138, C139, C140, C141, C142, C144, C145, C147, C148, C149, C150, C151, C152, C153, C154, C155, C156, C157, C158, C159, C160, C161, C162, C163, C164, C165, C168, C169, C170, C171, C21, C23, C24, C25, C28, C29, C30, C39, C40, C41, C42, C43, C44, C45, C46, C47, C48, C49, C51, C52, C53, C54, C55, C56, C57, C58, C61, C62, C68, C74, C83, C84, C85, C86, C91, C94, C97, C98, C99, F1b, FAITH-2, Q7.2 |
| `Means` | A2 | `VOCAB` | Vocabulary: the meaning-act relation — a subject means a proposition. | C100, C101, C102, C103, C104, C105, C106, C107, C116, C117, C118, C119, C120, C121, C122, C137, C138, C139, C140, C141, C142, C144, C145, C147, C148, C149, C150, C151, C152, C153, C154, C155, C156, C157, C158, C159, C160, C161, C162, C163, C164, C165, C168, C169, C170, C171, C21, C23, C24, C25, C28, C29, C30, C39, C40, C41, C42, C43, C44, C45, C46, C47, C48, C49, C51, C52, C53, C54, C55, C57, C61, C62, C68, C74, C83, C84, C94, C97, C98, C99, F1b, FAITH-2 |
...
- GAPMAP claims with a kernel declaration located (FOUND): **134** / 162
- Steps with an **English meaning in code**: **159** / 162 · **no gloss:** C88, C77, C92
...
- **Kernel-derived status** (#print axioms + axiom `Tag:`): **100 ✅** · **20 ⚠️** · **1 ◆** (unique steps detailed in the map)
- **Reconciled claim inventory (162 total):** 120 unique active steps (100 ✅ + 20 ⚠️) · 7 repeated / dissolved (→) · 22 blocked / missing (✖) · 5 deferred (➖) · 7 other (ANSWERED, DEMOTED, COUNTERMODEL, COUNTERMODEL, COUNTERMODEL, COUNTERMODEL, COUNTERMODEL)
- **Philosophical status histogram:** **CONDITIONAL 2** · **COUNTERMODEL 20** · **DEFINITIONAL 66** · **DISSOLVED 6** · **LOGICAL 34** · **METAPHYSICAL 17** · **OPEN 12** · **SEMANTIC 5**
...
| C164 | `Logos.RetorsiveNormativity.normative_stance_refutes_attack_without_axioms` | [RetorsiveNormativity.lean#L292](formal/Logos/RetorsiveNormativity.lean#L292) | `{Initiates, Means, State, Subject, CL}` | axiom `Subject` (VOCAB), `IndubitableNormativeFreeWill.GenuineNormativity`, `NormativeOrder.ClaimsNormativeCorrectness`, `NormativeOrder.claims_normative_correctness_derives_genuine_normativity`, `Order.Correct`, `Order.Incorrect`, `RetorsiveNormativity.GenuineNormativityExists`, `RetorsiveNormativity.NoGN` | `BipolarityRetorsion.A18_is_independent_optional_semantic_premise`, **C165** `attack_inviable_without_axioms` |
| C165 | `Logos.RetorsiveNormativity.attack_inviable_without_axioms` | [RetorsiveNormativity.lean#L319](formal/Logos/RetorsiveNormativity.lean#L319) | `{Initiates, Means, State, Subject, CL}` | axiom `Subject` (VOCAB), `Choice.Chooses`, `Choice.FreeWill`, `NormativeOrder.ClaimsNormativeCorrectness`, **C140** `claims_normative_correctness_derives_free_will`, `Order.Correct`, `Order.Incorrect`, `RetorsiveNormativity.NoGN`, **C164** `normative_stance_refutes_attack_without_axioms` | — |
| C166 | `Logos.BipolarityRetorsion.voice_without_normative_stance` | [BipolarityRetorsion.lean#L320](formal/Logos/BipolarityRetorsion.lean#L320) | `{}` | `BipolarityRetorsion.JudSigIncorrect`, `BipolarityRetorsion.JudicativeSig`, axiom `Means` (VOCAB), axiom `Subject` (VOCAB), `BipolarityRetorsion.M_oneway`, `BipolarityRetorsion.VoiceSig`, `BipolarityRetorsion.m_oneway_stance_fails`, `BipolarityRetorsion.m_oneway_voice_holds` | — |
...
| `voice_to_stance_not_forced_by_primitive_judicative_gamma` | theorem | [L329](formal/Logos/BipolarityRetorsion.lean#L329) | `theorem voice_to_stance_not_forced_by_primitive_judicative_gamma : ¬ (∀ (sig : J` | {}  |
| `voice_without_normative_stance` | theorem | [L320](formal/Logos/BipolarityRetorsion.lean#L320) | `theorem voice_without_normative_stance : ∃ (sig : JudicativeSig) (s : sig.Subjec` | {} → C166 |
...
| Name | Kind | Line | Statement (logic) | Axioms |
|---|---|---|---|---|
| `ActualEntity` | def | [L69](formal/Logos/NecessaryPersonalGround.lean#L69) | `def ActualEntity (e : Entity) : Prop` | {Subject}  |
| `ClaimA_NecessaryTruth` | def | [L127](formal/Logos/NecessaryPersonalGround.lean#L127) | `def ClaimA_NecessaryTruth (φ : Form) : Prop` | {}  |
| `ClaimD_NecessaryPerson` | def | [L131](formal/Logos/NecessaryPersonalGround.lean#L131) | `def ClaimD_NecessaryPerson : Prop` | {Means, Subject}  |
| `EntityMeans` | def | [L144](formal/Logos/NecessaryPersonalGround.lean#L144) | `def EntityMeans (e : Entity) (p : Prop) : Prop` | {Means, Subject}  |
| `ImpersonalEntity` | def | [L72](formal/Logos/NecessaryPersonalGround.lean#L72) | `def ImpersonalEntity (e : Entity) : Prop` | {Subject}  |
| `NecessaryNormativeOrder` | def | [L102](formal/Logos/NecessaryPersonalGround.lean#L102) | `def NecessaryNormativeOrder : Prop` | {Initiates, Means, State, Subject}  |
| `NormativeOrderAt` | def | [L98](formal/Logos/NecessaryPersonalGround.lean#L98) | `def NormativeOrderAt (_w : World) : Prop` | {Initiates, Means, State, Subject}  |
| `ObjectiveNormativeOrder` | def | [L81](formal/Logos/NecessaryPersonalGround.lean#L81) | `def ObjectiveNormativeOrder : Prop` | {Initiates, Means, State, Subject}  |
| `atom_cannot_ground_intentional_subject` | theorem | [L158](formal/Logos/NecessaryPersonalGround.lean#L158) | `theorem atom_cannot_ground_intentional_subject (n : Nat) (s : Subject) (p : Prop` | {Means, Subject}  |
| `atom_cannot_ground_person` | theorem | [L171](formal/Logos/NecessaryPersonalGround.lean#L171) | `theorem atom_cannot_ground_person (n : Nat) (s : Subject) (hPerson : Person s) :` | {Means, Subject}  |
| `de_dicto_not_implies_de_re` | theorem | [L255](formal/Logos/NecessaryPersonalGround.lean#L255) | `theorem de_dicto_not_implies_de_re : ∃ (W : Type) (S : Type) (ExistsAt : W → S →` | {}  |
| `established_normative_person` | theorem | [L231](formal/Logos/NecessaryPersonalGround.lean#L231) | `theorem established_normative_person (hClaims : ∃ s : Subject, ∃ p : Prop, Logos` | {Initiates, Means, State, Subject, Will, subjectWill, CL}  |
| `established_will_reality` | theorem | [L213](formal/Logos/NecessaryPersonalGround.lean#L213) | `theorem established_will_reality (hAssert : ∃ s : Subject, ∃ p : Prop, Logos.Age` | {AxIntentionalChoice, Initiates, Means, State, Subject, Will, subjectWill}  |
| `necessary_normative_order` | theorem | [L107](formal/Logos/NecessaryPersonalGround.lean#L107) | `theorem necessary_normative_order : NecessaryNormativeOrder` | {Initiates, Means, State, Subject}  |
| `necessary_normative_order_is_necessary` | theorem | [L119](formal/Logos/NecessaryPersonalGround.lean#L119) | `theorem necessary_normative_order_is_necessary : NecessaryNormativeOrder` | {Initiates, Means, State, Subject}  |
| `necessary_truth_exists` | theorem | [L245](formal/Logos/NecessaryPersonalGround.lean#L245) | `theorem necessary_truth_exists : ∃ τ : Form, □ τ` | {CL}  |
| `normative_order_is_grounded_in_personal_nature` | theorem | [L112](formal/Logos/NecessaryPersonalGround.lean#L112) | `theorem normative_order_is_grounded_in_personal_nature {s : Subject} {p : Prop} ` | {Initiates, Means, State, Subject, CL}  |
| `objective_normative_order_holds` | theorem | [L91](formal/Logos/NecessaryPersonalGround.lean#L91) | `theorem objective_normative_order_holds : ObjectiveNormativeOrder` | {Initiates, Means, State, Subject}  |
| `ofAtom_ne_ofSubject` | theorem | [L138](formal/Logos/NecessaryPersonalGround.lean#L138) | `theorem ofAtom_ne_ofSubject (n : Nat) (s : Subject) : Entity.ofAtom n ≠ EntityOf` | {Subject}  |
| `rational_act_carries_personal` | theorem | [L198](formal/Logos/NecessaryPersonalGround.lean#L198) | `theorem rational_act_carries_personal (s : Subject) (p : Prop) (hAct : Logos.Age` | {Initiates, Means, State, Subject, CL}  |
| `step1_necessary_truth_exists` | theorem | [L183](formal/Logos/NecessaryPersonalGround.lean#L183) | `theorem step1_necessary_truth_exists : ∃ τ : Form, □ τ` | {CL}  |
| `step3_personal_logical_inseparability` | theorem | [L189](formal/Logos/NecessaryPersonalGround.lean#L189) | `theorem step3_personal_logical_inseparability (a : Prop) (hAct : Logos.Person.Ra` | {Initiates, Means, State, Subject, CL}  |
...
| `direction_stack` | def | [L231](formal/Logos/PersonalGroundOfReality.lean#L231) | `def direction_stack : List (String × String)` | {}  |
| `every_judicative_act_grounds_its_own_polarity` | theorem | [L115](formal/Logos/PersonalGroundOfReality.lean#L115) | `theorem every_judicative_act_grounds_its_own_polarity : ∀ (s : Subject) (q : Pro` | {Initiates, Means, State, Subject, CL}  |
| `forward_normative_derivation_to_personal_ground` | theorem | [L209](formal/Logos/PersonalGroundOfReality.lean#L209) | `theorem forward_normative_derivation_to_personal_ground (s : Subject) (p q : Pro` | {Means, Subject}  |
| `forward_pipeline` | theorem | [L215](formal/Logos/PersonalGroundOfReality.lean#L215) | `theorem forward_pipeline (s : Subject) (p q : Prop) : RightWrongAt s p q → Perso` | {Means, Subject}  |
...
| `judicative_stance_forces_person` | theorem | [L98](formal/Logos/PersonalGroundOfReality.lean#L98) | `theorem judicative_stance_forces_person : ∀ (s : Subject) (p : Prop), ClaimsNorm` | {Initiates, Means, State, Subject, CL} → C149 |
...
| `person_grounds_initial_normative_datum` | theorem | [L225](formal/Logos/PersonalGroundOfReality.lean#L225) | `theorem person_grounds_initial_normative_datum (s : Subject) (p q : Prop) (h0 : ` | {Means, Subject}  |
| `person_grounds_normative_order` | theorem | [L109](formal/Logos/PersonalGroundOfReality.lean#L109) | `theorem person_grounds_normative_order : ∀ (s : Subject), Person s → GroundsRigh` | {Means, Subject} → C150 |
| `person_yields_personal_grounding_of_reality` | theorem | [L188](formal/Logos/PersonalGroundOfReality.lean#L188) | `theorem person_yields_personal_grounding_of_reality (s : Subject) (hPerson : Per` | {Initiates, Means, State, Subject} → C153 |
| `personal_ground_of_right_exists` | theorem | [L160](formal/Logos/PersonalGroundOfReality.lean#L160) | `theorem personal_ground_of_right_exists (hDatum : ∃ s : Subject, RightWrong s) :` | {Initiates, Means, State, Subject} → C152 |
| `personal_ground_of_right_exists_of_claims` | theorem | [L168](formal/Logos/PersonalGroundOfReality.lean#L168) | `theorem personal_ground_of_right_exists_of_claims (hDatum : ∃ s : Subject, ∃ p :` | {Initiates, Means, State, Subject, CL}  |
| `present_act_yields_personal_grounding_of_reality` | theorem | [L198](formal/Logos/PersonalGroundOfReality.lean#L198) | `theorem present_act_yields_personal_grounding_of_reality (s : Subject) (hPerson ` | {Initiates, Means, State, Subject}  |
...
| `the_person_supports_the_reality_of_right` | theorem | [L142](formal/Logos/PersonalGroundOfReality.lean#L142) | `theorem the_person_supports_the_reality_of_right : (¬ ∃ s : Subject, ClaimsCorre` | {Initiates, Means, State, Subject, CL} → C151 |
...
| `attack_a_phonetic_emission_not_assertion` | theorem | [L346](formal/Logos/RetorsiveNormativity.lean#L346) | `theorem attack_a_phonetic_emission_not_assertion (s : Subject) (p : Prop) (hNotA` | {Initiates, Means, State, Subject}  |
| `attack_b_falsehood_does_not_prevent_presupposition` | theorem | [L354](formal/Logos/RetorsiveNormativity.lean#L354) | `theorem attack_b_falsehood_does_not_prevent_presupposition (s : Subject) (hClaim` | {AxJudicativeBipolarity, Initiates, Means, State, Subject}  |
| `attack_c_withdrawal_from_correctness` | theorem | [L360](formal/Logos/RetorsiveNormativity.lean#L360) | `theorem attack_c_withdrawal_from_correctness (s : Subject) (p : Prop) (hNoClaim ` | {Initiates, Means, State, Subject}  |
| `attack_d_correctness_is_normative_partition` | theorem | [L368](formal/Logos/RetorsiveNormativity.lean#L368) | `theorem attack_d_correctness_is_normative_partition (s : Subject) (p : Prop) (hA` | {Initiates, Means, State, Subject, CL}  |
| `attack_e_judging_act_instantiates_normativity` | theorem | [L374](formal/Logos/RetorsiveNormativity.lean#L374) | `theorem attack_e_judging_act_instantiates_normativity (s : Subject) (hClaim : Cl` | {AxJudicativeBipolarity, Initiates, Means, State, Subject}  |
| `attack_inviable_without_axioms` | theorem | [L319](formal/Logos/RetorsiveNormativity.lean#L319) | `theorem attack_inviable_without_axioms (h : ∃ s : Subject, ∃ p : Prop, ClaimsNor` | {Initiates, Means, State, Subject, CL} → C165 |
...
| `normative_stance_refutes_attack_without_axioms` | theorem | [L292](formal/Logos/RetorsiveNormativity.lean#L292) | `theorem normative_stance_refutes_attack_without_axioms (h : ∃ s : Subject, ∃ p :` | {Initiates, Means, State, Subject, CL} → C164 |
